...
<html>
	...
	<body class="is-preload">
		...
		<!-- Wrapper-->
            ...
            <a href="../index.php" onclick="return confirm('Yakin Ingin Logout?')" value="Logout" /><i class="bi bi-box-arrow-in-right"></i><span>Logout</span></a>
					</nav>
							...
							<article id="pengaduan" class="panel">
								...
								<form action="" method="post" enctype="multipart/form-data">
									<div>
										...
										<input type="text" name="tgl" class="form_input2" required value="<?php date_default_timezone_set('Asia/Jakarta'); echo date('Y-m-d (H:i:s)') ?>" readonly></div>
												<div class="col-8 col-12-medium">
                        <input type="text" name="nama" class="form_input2" required value="<?php echo $_SESSION['nama']?>" readonly></div>
                        <div class="col-8 col-12-medium">
                        <input type="text" name="tlp" required class="form_input2" value="<?php echo $_SESSION['tlp']?>" readonly></div>
												<div class="col-8 col-12-medium">
                        <input type="text" name="nik" class="form_input2" required value="<?php echo $_SESSION['nik']?>" readonly></div>
												<div class="col-8">
												<input type="file" required name="gambar"></div>
												<input type="hidden" name="st" value="Proses">
												<div class="col-12">
												<textarea name="laporan" cols="90" placeholder="Kirimkan Masukan" required rows="8"></textarea></div>
												<div class="col-xl-3">
